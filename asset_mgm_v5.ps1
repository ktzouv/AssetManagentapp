...
$result| Select-Object -property IPAddress,Computername,hardware,OS,OSVersion,CPU,TotalPhysicalMemory,FreePhysicalMemory,HDD_C,Free Space C -ExcludeProperty PSComputername,RunspaceID
